    ...
    <div className="min-h-screen bg-cyan-800 flex flex-col items-center justify-center p-8 my-12">
      ...
      <div className="max-w-6xl w-full relative">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-12 min-h-[400px] flex flex-col justify-center transition-all duration-500">
          <div className="space-y-4">
            <div className="text-cyan-700 text-md font-semibold tracking-wide">
              {publications[currentIndex].type}
            </div>
            <h3 className="text-xl md:text-3xl font-bold text-cyan-900 leading-tight">
              {publications[currentIndex].title}
            </h3>
            <div className="text-cyan-800 text-lg">
              {publications[currentIndex].authors}
            </div>
            <div className="text-cyan-700 italic pt-4">
      ...
      <div className="max-w-6xl w-full mt-8 text-center">
        <p className="text-2xl text-white font-semibold">
          Join us at ICLSMHA and unlock the opportunity to publish your research in reputed <br/>Scopus / SCIE indexed journals.
        </p>
      </div>
    </div>
  );
